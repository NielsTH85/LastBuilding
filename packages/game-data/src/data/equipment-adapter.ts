...
const SUPPLEMENTAL_AFFIXES: AffixDef[] = [
  {
    ...
    operation: "add",
    tiers: [
      { tier: 1, minValue: 2, maxValue: 2, levelRequirement: 0, extraRolls: [{ minValue: 0.04, maxValue: 0.05 }] },
      { tier: 2, minValue: 3, maxValue: 3, levelRequirement: 0, extraRolls: [{ minValue: 0.06, maxValue: 0.07 }] },
      { tier: 3, minValue: 4, maxValue: 4, levelRequirement: 0, extraRolls: [{ minValue: 0.08, maxValue: 0.1 }] },
      { tier: 4, minValue: 5, maxValue: 5, levelRequirement: 0, extraRolls: [{ minValue: 0.11, maxValue: 0.13 }] },
      { tier: 5, minValue: 6, maxValue: 6, levelRequirement: 0, extraRolls: [{ minValue: 0.14, maxValue: 0.16 }] },
      { tier: 6, minValue: 8, maxValue: 8, levelRequirement: 0, extraRolls: [{ minValue: 0.18, maxValue: 0.2 }] },
      { tier: 7, minValue: 9, maxValue: 10, levelRequirement: 0, extraRolls: [{ minValue: 0.21, maxValue: 0.25 }] },
      { tier: 8, minValue: 16, maxValue: 20, levelRequirement: 0, extraRolls: [{ minValue: 0.4, maxValue: 0.5 }] },
    ],
    tags: ["amulet"],
  ...
  },
  {
    ...
    operation: "add",
    tiers: [
      { tier: 1, minValue: 0.008, maxValue: 0.008, levelRequirement: 0, extraRolls: [{ minValue: 0.008, maxValue: 0.008 }] },
    ],
    tags: ["idol"],
    additionalProperties: [
      { targetStat: "fire_resistance", operation: "add", extraRollIndex: 0 },
    ],
  },
  {
    id: "affix-1078",
    ...
    operation: "add",
    tiers: [
      { tier: 1, minValue: 4, maxValue: 4, levelRequirement: 0, extraRolls: [{ minValue: 2, maxValue: 2 }] },
      { tier: 2, minValue: 5, maxValue: 5, levelRequirement: 0, extraRolls: [{ minValue: 2, maxValue: 2 }] },
      { tier: 3, minValue: 5, maxValue: 5, levelRequirement: 0, extraRolls: [{ minValue: 3, maxValue: 3 }] },
      { tier: 4, minValue: 6, maxValue: 6, levelRequirement: 0, extraRolls: [{ minValue: 3, maxValue: 3 }] },
      { tier: 5, minValue: 6, maxValue: 6, levelRequirement: 0, extraRolls: [{ minValue: 3, maxValue: 3 }] },
      { tier: 6, minValue: 7, maxValue: 7, levelRequirement: 0, extraRolls: [{ minValue: 4, maxValue: 4 }] },
      { tier: 7, minValue: 7, maxValue: 7, levelRequirement: 0, extraRolls: [{ minValue: 4, maxValue: 4 }] },
      { tier: 8, minValue: 10, maxValue: 12, levelRequirement: 0, extraRolls: [{ minValue: 6, maxValue: 7 }] },
    ],
    tags: ["weapon2"],
    additionalProperties: [
  ...
  },
  {
    ...
    operation: "add",
    tiers: [
      { tier: 1, minValue: 4, maxValue: 4, levelRequirement: 0, extraRolls: [{ minValue: 1, maxValue: 1 }] },
      { tier: 2, minValue: 5, maxValue: 5, levelRequirement: 0, extraRolls: [{ minValue: 1, maxValue: 1 }] },
      { tier: 3, minValue: 5, maxValue: 5, levelRequirement: 0, extraRolls: [{ minValue: 1, maxValue: 1 }] },
      { tier: 4, minValue: 6, maxValue: 6, levelRequirement: 0, extraRolls: [{ minValue: 1, maxValue: 1 }] },
      { tier: 5, minValue: 6, maxValue: 6, levelRequirement: 0, extraRolls: [{ minValue: 1, maxValue: 1 }] },
      { tier: 6, minValue: 7, maxValue: 7, levelRequirement: 0, extraRolls: [{ minValue: 1, maxValue: 1 }] },
      { tier: 7, minValue: 7, maxValue: 7, levelRequirement: 0, extraRolls: [{ minValue: 1, maxValue: 1 }] },
      { tier: 8, minValue: 10, maxValue: 12, levelRequirement: 0, extraRolls: [{ minValue: 1, maxValue: 1 }] },
    ],
    tags: ["amulet"],
    additionalProperties: [
